Promise.all([
    ...
    , customElements.whenDefined('wa-input')
          ...
          // PATCH sliceName
          document.querySelector('#Page_sliceName')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#Page_sliceName')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_sliceName')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_sliceName');
            const valid = form.reportValidity();
          });
